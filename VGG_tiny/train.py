...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #act_parm
    act_parm = {'act_name': args.act_name, 'alpha': args.alpha, 'beta': args.beta, 'eps': args.eps, 'mode': args.mode}
    ...
    if args.pretrained:
        ...
        model = m.VGG_16(act_parm = act_parm)
    ...
    for key, value in param_dict.items():
        if 'pa' in key:
            params += [{'params':[value], 'lr':5*args.lr,
...
#                'momentum':args.momentum, 'weight_decay':args.weight_decay}]
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best, 'checkpoint_' + act_parm['act_name'] + '.pth.tar')
    
    print('Final Acc1 : %.3f, Acc5 : %.3f' %(best_acc1, best_acc5))
