...
class VGG_16(nn.Module):
    def __init__(self, input_size=64, input_channel=3, num_classes=200, act_parm={}):
        ...
        self.fc_3 = nn.Linear(in_features=1024, out_features=num_classes)
...
if __name__ == "__main__":
    ...
    x = torch.cuda.FloatTensor(np.random.random((2, 3, 64, 64)))
